...
var geo=""; //for now, geo will be set as a default
  ...
  if(db==='acs2024'){geo='carto';}
  if(db==='acs1923'){geo='carto';}
  if(db==='acs1822'){geo='carto';}
  if(db==='acs1721'){geo='carto';}
  if(db==='acs1620'){geo='carto';}
...
var moe='no';
if(db=='acs0610' || db=='acs0711' || db=='acs0812' || db=='acs0913' || db=='acs1014' || db=='acs1115' || db=='acs1216' || db=='acs1317' || db=='acs1418' || db=='acs1519' || db=='acs1620' || db=='acs1721' || db=='acs1822' || db=='acs1923' || db=='acs2024'){
  if (req.query.moe){
    moe=req.query.moe;
  }
} 
